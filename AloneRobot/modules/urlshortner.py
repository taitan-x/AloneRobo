...
@Alone.on_message(filters.command(["short"]))
...
@Alone.on_message(filters.command(["unshort"]))
...
# Alone.add_handler(MessageHandler(short_urls))
# Alone.add_handler(MessageHandler(unshort))
__help__ = """
