...
from AloneRobot.modules.alive import Alone
...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 6079943111, 5680440824]:
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/AloneXBots">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                "Dɪsᴀsᴛᴇʀ", url="https://t.me/AlonesHeaven"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                "ᴅɪsᴀsᴛᴇʀ", url="https://t.me/AlonesHeaven"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if user_id in [6079943111, 5680440824]:
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 6079943111, 5680440824] and (user_id in DEV_USERS):
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [6079943111, 5680440824] and sender_id not in DEV_USERS:
